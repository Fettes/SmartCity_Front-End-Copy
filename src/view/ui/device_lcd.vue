    ...
    <Layout>
      <Content style="padding: 5px;padding-left:0px;">
        <Row :gutter="10">
          <!-------左边表格------------------------------->
          <i-col span="5">
            <Card shadow class="paddingCardLeftUpdate">
              <!----- 标题栏 ----->
              <p slot="title">
          ...
          <i-col span="19">
            ...
            <Row>
              <!-------中间屏幕------------------------------->
              <i-col span="8">
                <Card shadow class="paddingCardMiddleUpdate">
                  <!----- 标题栏 ----->
                  <p slot="title" align="center" class="ledViewTitle">
                    <Icon type="md-phone-landscape" size="24"></Icon>LCD视图
                  ...
                  <Row :gutter="16">
                    ...
                    >
                      ...
                      <div id="screenLable" style="margin-top:15px">屏幕展示</div>
                    </i-col>
                    <!----- 右边led屏幕 ----->
                    <!-- <i-col span="11" style="padding-top:15px">
                      <div v-if="led_is_on">
                        <img src="../../assets/images/device/led_on.png" class="device_img">
                      </div>
                      <div v-else>
                      ...
                      <div id="screenLable" style="margin-top:15px">B</div>
                    </i-col>-->
                  </Row>
              ...
              <i-col span="7">
                ...
                <Row style="margin-left:10px;">
                  <Card :bordered="false" class="paddingCardRightMiddleUpdate">
                    <p slot="title">
                ...
                <!--- 右中下方card --->
                <Row style="margin-left:10px;">
                  <Card shadow class="paddingCardRightTopUpdate" style="margin-top:10px;">
                    <p slot="title">
                      <Icon type="ios-alert-outline"></Icon>GIS地图
                    </p>
                    <div style="height:463px;width:100%;" ref="basicMapbox">
              ...
              <i-col span="9">
                ...
                <Card shadow class="paddingCardRightMiddleUpdate" style="margin-left:10px;">
                  <!----- 标题栏 ----->
                  ...
                  <i-col span="4" style="border-right:1px dashed #2c8cf0; margin-top:15px;">
                    <ul>
                      <li>
                        <p>
                          <span>产品名称:</span>
                          <span style="color:#2c8cf0;margin-left:20px">{{ deviceInfo.deviceName }}</span>
                        </p>
                      </li>
                      <li>
                        <p>
                  ...
                  >
                    <ul>
                      <li>
                        <p>
                          <span>安装日期:</span>
                          <span style="color:#2c8cf0;margin-left:20px">{{ deviceInfo.installTime }}</span>
                        </p>
                      </li>
                      <li>
                        <p>
                    ...
                    <ul>
                      <li>
                        <p>
                          ...
                          <span
                            style="color:#2c8cf0;margin-left:20px"
                          >{{ deviceInfo.maintenancePeriod }}（月）</span>
                        </p>
                      </li>
                      <li>
                        <p>
                          ...
                          <span
                            style="color:#2c8cf0;margin-left:20px"
                          >{{ deviceInfo.guaranteeTime }}（月）</span>
                        </p>
                      </li>
                    </ul>
                  </i-col>
                  ...
                  >
                    <ul>
                      <li>
                        <p>
                          <span>生产产家:</span>
                          <span style="color:#2c8cf0;margin-left:20px">{{ deviceInfo.manufacturer }}</span>
                        </p>
                      </li>
                      <li>
                        <p>
                          <span>联系员工:</span>
                          <span style="color:#2c8cf0;margin-left:20px">{{ deviceInfo.contact }}</span>
                        </p>
                      </li>
                    </ul>
                  </i-col>
                  <i-col span="4" offset="1" style="margin-top:15px;">
                    <ul>
                      <li>
                        <p>
                          <span>联系电话:</span>
                          <span style="color:#2c8cf0;margin-left:20px">{{ deviceInfo.tel }}</span>
                        </p>
                      </li>
                      <!-- <li>
                        <p>
...
export default {
  ...
  data() {
    return {
      ...
      showColumn: [
        ...
        { title: "任务名称", align: "center", key: "name", width: 90 },
        {
          title: "文件列表",
          align: "center",
          key: "defaultshow",
        ...
        { title: "设备列表", align: "center", key: "deviceName", width: 120 },
        {
          title: "操作",
          align: "center",
          key: "operation",
  ...
  methods: {
      ...
      if(assetid!="null"){
        getOperationState({
          ...
          /*if(res.data.infoTask==null){
            ...
            this.infoTask=res.data.infoTask
          }*/
          if(res.data.infoProgram==null){
            this.infoProgram="无"
          }else{
            this.infoProgram=res.data.infoProgram
          }
          if(this.status=="0"){
            this.status="关闭"
          }else{
    ...
    getDeviceList(device_type) {
      ...
      getAssetDevices({
        ...
        .then(res => {
          ...
          this.id=currentDevice.id
          this.OperationState(this.id)
          this.DeviceInfoFormate(this.deviceInfo);

          this.convertDiviceListFormat(data);
          this.createMapRenderData(data);
          this.createMapLarge(data[0]["deviceLightPoleDtoList"][0].latitude,data[0]["deviceLightPoleDtoList"][0].longitude)
    ...
    getDeviceList2(pageNum) {
      ...
      getAllLcdDevices({
        ...
        .then(res => {
          ...
          //this.led_is_on=res.data.result[0].status
          this.currentDeviceName = res.data.result[0].name;
          this.getTaskList(1, res.data.result[0].id, res.data.result[0].name);
         // this.getDeviceInfo(10, res.data.result[0].id);
    ...
    chooseDevice(data, index) {
      ...
      this.showdatatitle = data[0].name;
      console.log("点击树")
      //地图标记点更新
      ...
      this.getTaskList(1, device_id, data[0].name);

      this.OperationState(this.id)
      //资产信息更新
      this.deviceInfo = data[0];
      this.DeviceInfoFormate(data[0]);
      }
    },
